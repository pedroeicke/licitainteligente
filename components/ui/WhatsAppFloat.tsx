...
export function WhatsAppFloat() {
  return (
    ...
    >
      <span className="pointer-events-none hidden translate-x-2 whitespace-nowrap rounded-full bg-white px-4 py-2 text-sm font-semibold text-ink opacity-0 shadow-soft ring-1 ring-line transition-all duration-300 group-hover:translate-x-0 group-hover:opacity-100 md:block">
        Fale no WhatsApp
      </span>
